...
var ManageOrderComponent = (function () {
    ...
    ManageOrderComponent.prototype.confirmitm = function () {
        ...
        if (cfconfirm) {
            this.manageOrderService.adminStatusConfirm(this.OrderDetail, this.shipping).subscribe(function (data) {
...
var ManageOrderService = (function () {
    ...
    ManageOrderService.prototype.adminStatusConfirm = function (order, shipping) {
