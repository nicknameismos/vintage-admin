        ...
        if (_type === 'start') {
            if (!isNaN(secondDate_1.getTime())) {
                if (secondDate_1.getTime() >= firstDate_1.getTime()) {
                    ...
                    var defaultDateNow_mod_1 = dateNow.getFullYear() + '-' + month_n + '-' + date_n + 'T' + incHr_n + ':' + incMin_n;
                    this.bidData.starttime = '';
                    this.bidData.endtime = '';
                    setTimeout(function () {
                        _this.bidData.starttime = defaultDateNow_mod_1;
                        _this.bidData.endtime = defaultDateNow_mod_1;
                    }, 50);
                }
            }
        }
