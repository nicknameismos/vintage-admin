...
var BidComponent = (function () {
    ...
    BidComponent.prototype.pageingN = function () {
        var bidlist = JSON.parse(JSON.stringify(this.bidlist));
    ...
    BidComponent.prototype.pageingP = function () {
        var oldpage = this.currentPageSelected;
        var bidlist = JSON.parse(JSON.stringify(this.bidlist));
...
var ROUTES = [
    ...
    { path: 'manage-order', title: 'จัดการคำสั่งซื้อ', icon: '', class: '' },
...
var ManageCouponComponent = (function () {
    ...
    ManageCouponComponent.prototype.pageingN = function () {
        var couponlist = JSON.parse(JSON.stringify(this.couponTabs));
        if (this.currentPageSelected === 0) {
            this.currentPageSelected = 1;
        }
        this.currentPageSelected++;
    ...
    ManageCouponComponent.prototype.pageingP = function () {
        var oldpage = this.currentPageSelected;
        var couponlist = JSON.parse(JSON.stringify(this.couponTabs));
        if (this.currentPageSelected > 1) {
            this.currentPageSelected--;
...
var ManageOrderComponent = (function () {
    ...
    ManageOrderComponent.prototype.pageingN = function () {
        var orderlist = JSON.parse(JSON.stringify(this.OrderList));
        if (this.currentPageSelected === 0) {
            this.currentPageSelected = 1;
        }
        this.currentPageSelected++;
    ...
    ManageOrderComponent.prototype.pageingP = function () {
        var oldpage = this.currentPageSelected;
        var orderlist = JSON.parse(JSON.stringify(this.OrderList));
        if (this.currentPageSelected > 1) {
            this.currentPageSelected--;
    ...
    ManageOrderComponent.prototype.onClickDetail = function (item) {
        ...
        if (selection.toString().length === 0) {
            ...
            this.manageOrderService.orderDetail(item.orderid, item.itemid).subscribe(function (data) {
                ...
                _this.pubsub.$pub('loading', false);
                $(_this.modalDetail.nativeElement).modal('show');
            }, function (err) {
                _this.pubsub.$pub('loading', false);
                console.log(err);
            });
    ...
    ManageOrderComponent.prototype.adminCancelitm = function (remark) {
        var _this = this;
        this.remark = remark;
        var cfcancel = confirm('ยืนยันการยกเลิกคำสั่งซื้อ');
        if (cfcancel) {
...
var ManageShopComponent = (function () {
    ...
    ManageShopComponent.prototype.pageingN = function () {
        var shoplist = JSON.parse(JSON.stringify(this.shopsL));
        if (this.currentPageSelected === 0) {
            this.currentPageSelected = 1;
        }
        this.currentPageSelected++;
    ...
    ManageShopComponent.prototype.pageingP = function () {
        var oldpage = this.currentPageSelected;
        var shoplist = JSON.parse(JSON.stringify(this.shopsL));
        if (this.currentPageSelected > 1) {
            this.currentPageSelected--;
...
var ManageUserComponent = (function () {
    ...
    ManageUserComponent.prototype.pageingN = function () {
        var usrlist = JSON.parse(JSON.stringify(this.userList));
        if (this.currentPageSelected === 0) {
            this.currentPageSelected = 1;
        }
        this.currentPageSelected++;
    ...
    ManageUserComponent.prototype.pageingP = function () {
        var oldpage = this.currentPageSelected;
        var usrlist = JSON.parse(JSON.stringify(this.userList));
        if (this.currentPageSelected > 1) {
            this.currentPageSelected--;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('modalEditUser'),
    __metadata("design:type", Object)
], ManageUserComponent.prototype, "modalEditUser", void 0);
