...
var BidComponent = (function () {
    ...
    BidComponent.prototype.InitialData = function () {
        ...
        this.bidService.getShipingMaster().subscribe(function (data) {
            ...
            console.log(_this.shippingMaster);
        }, function (err) {
            console.log(err);
    ...
    BidComponent.prototype.calcDate = function (_type) {
        ...
        if (diffDays > 1) {
            ...
            setTimeout(function () {
                _this.bidData.starttime = _this.oldDate.starttime;
                _this.bidData.endtime = _this.oldDate.endtime;
            }, 50);
    ...
    BidComponent.prototype.editBid = function (item) {
        ...
        for (var i = 0; i < this.shippingMaster.length; i++) {
            for (var j = 0; j < this.bidData.shippings.length; j++) {
...
var ManageCouponComponent = (function () {
    ...
    ManageCouponComponent.prototype.getCoupon = function () {
        var _this = this;
        this.pubsub.$pub('loading', true);
        this.couponService.getList().subscribe(function (resp) {
            _this.couponlist = resp;
...
var ManageOrderComponent = (function () {
    ...
    ManageOrderComponent.prototype.confirmitm = function () {
        ...
        if (cfconfirm) {
            this.manageOrderService.changeStatusConfirm(this.OrderDetail).subscribe(function (data) {
