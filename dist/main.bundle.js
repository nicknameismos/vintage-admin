...
var BidComponent = (function () {
    ...
    BidComponent.prototype.calcDate = function (_type) {
        ...
        var date2 = new Date(this.bidData.endtime);
        var _month2 = date2.getMonth() <= 9 ? '0' + (date2.getMonth() + 1) : date2.getMonth() + 1;
        var _date2 = date2.getDate() <= 9 ? '0' + date2.getDate() : date2.getDate();
        var _incHr2 = (date2.getHours() - 1) <= 9 ? '0' + (date2.getHours() - 1) : (date2.getHours() - 1);
        var _incMin2 = date2.getMinutes() <= 9 ? '0' + date2.getMinutes() : date2.getMinutes();
        var defaultDate2 = date2.getFullYear() + '-' + _month2 + '-' + _date2 + 'T' + _incHr2 + ':' + _incMin2;
