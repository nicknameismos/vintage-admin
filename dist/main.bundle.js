...
var BidComponent = (function () {
    ...
    BidComponent.prototype.InitialData = function () {
        var _this = this;
        this.bidService.getBid().subscribe(function (data) {
            _this.bidlist = data;
    ...
    BidComponent.prototype.calcDate = function (_type) {
        ...
        var _incHr = (date.getHours() + 1) <= 9 ? '0' + (date.getHours() + 1) : (date.getHours() + 1);
        var _incMin = date.getMinutes() <= 9 ? '0' + date.getMinutes() : date.getMinutes();
        var defaultDate = date.getFullYear() + '-' + _month + '-' + _date + 'T' + _incHr + ':' + _incMin;
        this.bidData.endtime = _type === 'end' ? this.bidData.endtime : defaultDate;
        var oneDay = 24 * 60 * 60 * 1000;
        var firstDate = new Date(this.bidData.starttime);
        var secondDate = new Date(this.bidData.endtime);
    ...
    BidComponent.prototype.selectTab = function (name) {
...
// module
exports.push([module.i, "@font-face {\r\n    font-family: 'icomoon';\r\n    src:url('data:application/vnd.ms-fontobject;base64,');\r\n    src:url(" + escape(__webpack_require__("../../../../../src/assets/fonts/icomoon-cs/fonts/icomoon.eot")) + "?#iefix-haa506) format('embedded-opentype'),\r\n        url('data:application/font-woff;base64,') format('woff'),\r\n        url('data:application/x-font-ttf;base64,') format('truetype');\r\n    font-weight: normal;\r\n    font-style: normal;\r\n}\r\n\r\n[class^=\"icon-\"], [class*=\" icon-\"] {\r\n    font-family: 'icomoon';\r\n    font-style: normal;\r\n    font-weight: normal;\r\n    font-variant: normal;\r\n    text-transform: none;\r\n    line-height: 1;\r\n\r\n    /* Better Font Rendering =========== */\r\n    -webkit-font-smoothing: antialiased;\r\n    -moz-osx-font-smoothing: grayscale;\r\n}\r\n\r\n.icon-home:before {\r\n    content: \"\\E901\";\r\n}\r\n\r\n.icon-images:before {\r\n    content: \"\\E901\";\r\n}\r\n\r\n.icon-pawn:before {\r\n    content: \"\\E902\";\r\n}\r\n\r\n/*  */\r\n\r\n.caret {\r\n    margin-top: 13px;\r\n    position: absolute;\r\n    right: 18px;\r\n}\r\n\r\n.bg2 {\r\n    background-color: #ffffff !important;\r\n}\r\n\r\n.logo-img img {\r\n    width: 68px !important;\r\n    top: 12px !important;\r\n}\r\n\r\n.mgt-20 {\r\n    margin-left: 20px;\r\n}\r\n\r\n.nav p {\r\n    color: #345f2a  !important\r\n}\r\n\r\n.nav i {\r\n    color: #345f2a  !important\r\n}\r\n\r\n.logo {\r\n    background: #ffffff;\r\n}\r\n\r\n.sidebar .logo, .off-canvas-sidebar .logo {\r\n    padding: 10px 15px !important;\r\n}\r\n\r\n\r\n\r\n\r\n", ""]);
...
var CreateShopComponent = (function () {
    ...
    CreateShopComponent.prototype.createFormControls = function () {
        ...
        this.email = new __WEBPACK_IMPORTED_MODULE_6__angular_forms__["FormControl"]('', [
            ...
            __WEBPACK_IMPORTED_MODULE_6__angular_forms__["Validators"].pattern("[^ @]*@[^ @]*")
        ]);
    };
...
var ManageCouponComponent = (function () {
    function ManageCouponComponent(UserService, server, pubsub, router) {
        ...
        this.UserService.getUser().subscribe(function (jso) {
            ...
            _this.listAllUser.forEach(function (element) {
                if (element.name === 'customer') {
                    _this.listUser.push(element.users);
                }
            ...
            _this.user = _this.listUser[0].concat(_this.listUser[1].concat(_this.listUser[2]));
...
var ManageCouponService = (function () {
    ...
    // }
    ManageCouponService.prototype.createCoupon = function () {
...
module.exports = __webpack_require__.p + "icomoon.3adcd650be981a40feea.eot";
